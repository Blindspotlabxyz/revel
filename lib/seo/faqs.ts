export const revelFaqs = [
  ...
  },
  {
    ...
    answer:
      "Most analyses complete in 30 to 60 seconds. You'll see each step complete in real time as Revel investigates your product.",
  },
  {
    question: "Can I export results?",
    answer:
      "Yes. Export your Blueprint and Action Queue as Markdown or JSON. Notion and Linear integrations are coming soon.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes, but you never choose models or write prompts. Revel handles the technology. You focus on the insights.",
  },
  {
